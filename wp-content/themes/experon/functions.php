<?php
/**
 * Setup theme functions for Experon.
 *
 * @package ThinkUpThemes
 */

// Declare latest theme version
$GLOBALS['thinkup_theme_version'] = '1.2.6';
...
if ( ! function_exists( 'thinkup_themesetup' ) ) {
	...
	function thinkup_themesetup() {
		...
		register_nav_menus( array( 'pre_header_menu' => __( 'Pre Header Menu', 'experon' ) ) );
		register_nav_menus( array( 'header_menu'     => __( 'Primary Header Menu', 'experon' ) ) );
		register_nav_menus( array( 'sub_footer_menu' => __( 'Footer Menu', 'experon' ) ) );
	}
}
...
function thinkup_frontscripts() {
	...
	if ( thinkup_check_isblog() or is_archive() ) {
...
function thinkup_widgets_init() {
    ...
    register_sidebar( array(
        'name'          => __( 'Footer Column 1', 'experon' ),
        'id'            => 'footer-w1',
        'before_widget' => '<aside class="widget %2$s">',
        'after_widget'  => '</aside>',
    ...
    register_sidebar( array(
        'name'          => __( 'Footer Column 2', 'experon' ),
        'id'            => 'footer-w2',
        'before_widget' => '<aside class="widget %2$s">',
        'after_widget'  => '</aside>',
        'before_title'  => '<h3 class="footer-widget-title"><span>',
    ...
    register_sidebar( array(
        'name'          => __( 'Footer Column 3', 'experon' ),
        'id'            => 'footer-w3',
        'before_widget' => '<aside class="widget %2$s">',
        'after_widget'  => '</aside>',
        'before_title'  => '<h3 class="footer-widget-title"><span>',
    ...
    register_sidebar( array(
        'name'          => __( 'Footer Column 4', 'experon' ),
        'id'            => 'footer-w4',
        'before_widget' => '<aside class="widget %2$s">',
        'after_widget'  => '</aside>',
        'before_title'  => '<h3 class="footer-widget-title"><span>',
    ...
    register_sidebar( array(
        'name'          => __( 'Footer Column 5', 'experon' ),
        'id'            => 'footer-w5',
        'before_widget' => '<aside class="widget %2$s">',
        'after_widget'  => '</aside>',
        'before_title'  => '<h3 class="footer-widget-title"><span>',
    ...
    register_sidebar( array(
        'name'          => __( 'Footer Column 6', 'experon' ),
        'id'            => 'footer-w6',
        'before_widget' => '<aside class="widget %2$s">',
        'after_widget'  => '</aside>',
        'before_title'  => '<h3 class="footer-widget-title"><span>',
